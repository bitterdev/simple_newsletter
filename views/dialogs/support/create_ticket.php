...
use Concrete\Package\SimpleNewsletter\Controller\Dialog\Support\CreateTicket;
...
<form action="<?php echo (string)Url::to("/ccm/system/dialogs/simple_newsletter/create_ticket/submit"); ?>"
      data-dialog-form="create-ticket"
      method="post"
      enctype="multipart/form-data">

    <?php echo $form->hidden('projectHandle', "simple_newsletter"); ?>
