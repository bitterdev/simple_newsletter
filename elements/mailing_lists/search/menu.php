...
<div class="row row-cols-auto g-0 align-items-center">
    ...
    <ul class="ccm-dashboard-header-icons">
        <li>
            <a  class="ccm-hover-icon launch-tooltip" title="<?php echo h(t('Add Mailing List')) ?>" href="<?php echo \Concrete\Core\Support\Facade\Url::to("/dashboard/simple_newsletter/mailing_lists/add"); ?>">
