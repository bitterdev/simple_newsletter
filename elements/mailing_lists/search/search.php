...
<div class="ccm-header-search-form ccm-ui" data-header="mailing_list-manager">
        ...
        <div class="ccm-header-search-form-input input-group">
            <?php if (isset($query)): ?>
                <a href="javascript:void(0);"
                   ...
                   data-advanced-search-dialog-url="<?php echo Url::to('/ccm/system/dialogs/mailing_lists/advanced_search') ?>"
