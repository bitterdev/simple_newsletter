...
<div class="row row-cols-auto g-0 align-items-center">
    ...
    <ul class="ccm-dashboard-header-icons">
        <li>
            <a  class="ccm-hover-icon launch-tooltip" title="<?php echo h(t('Add Subscriber')) ?>" href="<?php echo \Concrete\Core\Support\Facade\Url::to("/dashboard/simple_newsletter/subscribers/add"); ?>">
                <i class="fas fa-plus" aria-hidden="true"></i>
            </a>
        </li>

        <li>
            <a  class="ccm-hover-icon launch-tooltip" title="<?php echo h(t('Manage Attributes')) ?>" href="<?php echo \Concrete\Core\Support\Facade\Url::to("/dashboard/simple_newsletter/subscribers/attributes"); ?>">
                <i class="fas fa-cog" aria-hidden="true"></i>
            </a>
        </li>

        <li>
            <a  class="ccm-hover-icon launch-tooltip" title="<?php echo h(t('Get Help')) ?>" href="javascript:void(0);" id="<?php echo h($helpId);?>">
    ...
    (function ($) {
        $("#<?php echo $helpId; ?>").click(function () {
            jQuery.fn.dialog.open({
                href: "<?php echo (string)\Concrete\Core\Support\Facade\Url::to("/ccm/system/dialogs/simple_newsletter/create_ticket"); ?>",
                modal: true,
                width: 500,
