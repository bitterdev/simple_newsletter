...
namespace Concrete\Package\SimpleNewsletter\Controller\Dialog\Subscribers\Preset;
...
class Edit extends PresetEdit
{
    ...
    public function getSavedSearchEntity()
    {
        ...
        if (is_object($em)) {
            return $em->getRepository(SavedSubscriberSearch::class);
        }
    ...
    {
        return (string) Url::to('/ccm/system/search/subscribers/preset', $search->getID());
    }
}