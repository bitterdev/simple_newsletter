...
namespace Concrete\Package\SimpleNewsletter\Controller\Element\MailingLists\Search;
...
class Search extends ElementController
{
    ...
    {
        return 'mailing_lists/search/search';
    }
    ...
    public function view()
    {
        ...
        if (isset($this->headerSearchAction)) {
            ...
            $this->set('headerSearchAction', $this->app->make('url')->to('/dashboard/simple_newsletter/mailing_lists'));
        }
